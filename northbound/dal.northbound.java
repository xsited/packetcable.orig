 ...
 * @header@
 */
package org.opendaylight.dal.northbound;
...
import org.opendaylight.dal.lib.notation.UUID;
import org.opendaylight.dal.lib.table.internal.Table;
import org.opendaylight.dal.lib.table.internal.Tables;
import org.opendaylight.dal.plugin.OVSDBConfigService;
import org.opendaylight.dal.plugin.StatusWithUuid;
...
@Path("/")
public class DALNorthbound {
    protected static final Logger logger = LoggerFactory.getLogger(DALNorthbound.class);
     ...
     *
     * Request URL:
     * https://localhost/controller/nb/v2/dal/tables/bridge/rows
     * </pre>
     */
