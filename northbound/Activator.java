...
import org.opendaylight.dal.northbound.trafficprofiles.defaults;

/**
 * Main application activator class for registering the dependencies and
 * initialising the DOCSIS Abstration Layer Service application.
 * 
 */
...
public class Activator extends ComponentActivatorAbstractBase {
    ...
    public Object[] getImplementations() {
        Object[] res = { DALNorthbound.class };
        return res;
    }
    ...
    public void configureInstance(Component c, Object imp, String containerName) {
        if (imp.equals(DALNorthbound.class)) {
            // export the service
            Dictionary<String, String> props = new Hashtable<String, String>();
            props.put("name", "mappingservice");
            c.setInterface(new String[] { IDALNorthbound.class.getName() }, props);
