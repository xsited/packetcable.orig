 ...
 */
public class CopsSSQTest extends CopsSSTest {

    public final static byte[] BASE_ARRAY = {16, 5, -128, 11, 0, 0, 0, 8};
    public final static byte[] ARRAY = {
            16, 5, 127, -11, 0, 0, 0, 16,
            0, 8, 1, 1, 0, 0, 0, 1
    };
    ...
    private void testEquals() throws CopsException {
        assertEquals(byteMe(new CopsSSQ(getBuffer(BASE_ARRAY))), getBuffer(BASE_ARRAY));
        assertEquals(byteMe(new CopsSSQ(32757, 1)), getBuffer(ARRAY));

        CopsSS e = new CopsSSQ(32757, 1);
    ...
    private void testLength() throws CopsException {
        CopsSS o = new CopsSSQ(getBuffer(BASE_ARRAY));
