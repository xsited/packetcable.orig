 ...
 */
        ...
        System.out.println("2. CMTS+PCMMPdpAgent.connect+COPSPdpSender Add Flow 2");
        ...
        System.out.println("9. localhost+PCMMPdpAgent.connect+COPSPdpSender Add Flow 2");
        // System.out.println("9. Add Flow 3");
		...
		socket_id = ps.requestCMTSConnection("10.32.4.3");
            ...
            case 2:
                ...
                try  {
                    pcmm_pdp.connect( "10.32.4.3", 3918 );
                } catch (Exception e) {
		...
		InetAddress srcIP = InetAddress.getByName("10.32.2.208");
		...
		socket_id = ps.requestCMTSConnection("127.0.0.1");
                ps.gateSet();
...
*/
		...
		try
		{
		     decisionMsg.writeData(lpdp.getSocket());
		     //decisionMsg.writeData(socket_id);
		}
		catch (IOException e)
		{
